...
static inline uint8_t inb(uint16_t port) {
    uint8_t ret;
    __asm__ __volatile__ ("inb %b0, %1" : "=a"(ret) : "Nd"(port));
    return ret;
}
__attribute__((always_inline))
static inline uint16_t inw(uint16_t port) {
    uint16_t ret;
    __asm__ __volatile__ ("inw %w0, %1" : "=a"(ret) : "Nd"(port));
    return ret;
}
__attribute__((always_inline))
static inline uint32_t inl(uint16_t port) {
    uint32_t ret;
    __asm__ __volatile__ ("ind %k0, %1" : "=a"(ret) : "Nd"(port));
    return ret;
}
__attribute__((always_inline))
...
static inline void io_wait() {
    __asm__ __volatile__ ("outb %0, %b1" : : "Nd"(0x80), "a"(0));
    __asm__ __volatile__ ("outb %0, %b1" : : "Nd"(0x80), "a"(0));
    __asm__ __volatile__ ("outb %0, %b1" : : "Nd"(0x80), "a"(0));
    __asm__ __volatile__ ("outb %0, %b1" : : "Nd"(0x80), "a"(0));
}
...
static inline void outb(uint16_t port, uint8_t value)
    { __asm__ __volatile__ ("outb %0, %b1" : : "Nd"(port), "a"(value)); }
__attribute__((always_inline))
static inline void outw(uint16_t port, uint16_t value)
    { __asm__ __volatile__ ("outw %0, %w1" : : "Nd"(port), "a"(value)); }
__attribute__((always_inline))
static inline void outl(uint16_t port, uint32_t value)
    { __asm__ __volatile__ ("outd %0, %k1" : : "Nd"(port), "a"(value)); }
__attribute__((always_inline))
